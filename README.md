...
To be updated with `./list_gists.py`.
...
* [commen-letters.py:  prints the common letters between an AZERTY and QWERTY keyboard (without Shift and Alt-GR)](https://gist.github.com/monperrus/421395b7be4073cc9398)
